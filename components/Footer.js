...
function Footer() {
  return (
    <footer className='flex w-full flex-col items-center bg-charcoal px-6 pt-[52px] pb-[38px] md:items-start md:px-10 md:pt-[60px] md:pb-[46px] lg:pb-12 lg:pt-[75px]'>
      <div className='lg:mx-auto lg:w-full lg:max-w-[1110px]'>
        <div className='relative flex flex-col items-center md:items-start lg:flex-row lg:items-center lg:justify-between'>
          <div className='absolute -top-[52px] h-1 w-[101px] bg-orange md:-top-[60px] lg:-top-[75px]' />
          <Link href='/'>
            <svg
          ...
          <div className='mt-12 flex flex-col items-center space-y-4 md:mt-8 md:flex-row md:space-y-0 md:space-x-[34px] lg:mt-0'>
            <Link href='/'>
        ...
        <div className='flex flex-col items-center md:mt-20 md:flex-row md:justify-between lg:mt-14'>
          ...
          <div className='mt-12 flex items-center space-x-4 md:mt-0 lg:-translate-y-[88px]'>
            <Link href='https://www.facebook.com'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-6 w-6 cursor-pointer fill-current text-white hover:text-orange'
              >
                <path
            ...
            <Link href='https://www.twitter.com'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-5 w-6 cursor-pointer fill-current text-white hover:text-orange'
              >
                <path
            ...
            <Link href='https://www.instagram.com'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-6 w-6
                cursor-pointer fill-current text-white hover:text-orange'
              >
                <path

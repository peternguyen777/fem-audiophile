...
export default function MobileMenu({ mobMenuOpen, setMobMenuOpen }) {
  ...
  const modalContent = (
    <div
      className={`mobMenuScroll fixed top-[90px] z-30 h-[calc(100vh-90px)] max-h-[750px] w-full select-none overflow-y-scroll rounded-b-lg bg-lightgray px-6 pb-[35px] pt-[84px] duration-300 ease-in-out md:hidden ${

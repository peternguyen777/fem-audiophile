...
function Header({ mobMenuOpen, setMobMenuOpen }) {
  return (
    <header className='sticky top-0 z-50 h-[90px] w-full bg-charcoal'>
      <div className='absolute top-1/2 mx-auto flex w-full -translate-y-1/2 items-center justify-between pl-[10px] pr-6 lg:left-0 lg:right-0 lg:max-w-[1190px] lg:px-10'>
        ...
        <svg
          ...
          className='absolute left-1/2 h-[25px] w-[143px] -translate-x-1/2 fill-current text-white lg:static lg:translate-x-0'
        >
          <path
        ...
        <svg
          xmlns='http://www.w3.org/2000/svg'
          className='h-[20px] w-[23px] fill-current text-white'
        >
          <path

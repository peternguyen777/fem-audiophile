        ...
        <div className='absolute top-1/2 mx-auto flex w-full -translate-y-1/2 items-center justify-between pl-[10px] pr-6 md:pr-10 md:pl-[26px] lg:left-0 lg:right-0 lg:max-w-[1190px] lg:pl-10'>
          ...
          <Link href='/'>
            <svg
              ...
              className='absolute left-1/2 h-[25px] w-[143px] -translate-x-1/2 cursor-pointer fill-current text-white lg:static lg:translate-x-0'
            >
              <path
          ...
          <div className='absolute left-1/2 mx-auto hidden -translate-x-1/2 space-x-[34px] lg:flex'>
            <Link href='/'>
